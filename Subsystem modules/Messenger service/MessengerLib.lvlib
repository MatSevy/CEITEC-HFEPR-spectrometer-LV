...
<Library LVVersion="21008000">
	...
	<Item Name="Examples" Type="Folder">
		<Item Name="Module example event handler inside.vi" Type="VI" URL="../Examples/Module example event handler inside.vi"/>
	</Item>
	<Item Name="Methodes" Type="Folder">
		<Item Name="Destroy multiple mailboxes.vi" Type="VI" URL="../Methodes/Destroy multiple mailboxes.vi"/>
